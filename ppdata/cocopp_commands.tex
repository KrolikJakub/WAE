...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6, hv-hashes inconsistent: ff0e71e8cd978373 and 4a3f8ada9d00cb99 and b90c6f3a4390470a found!}}
\providecommand{\numofalgs}{4}
...
\providecommand{\algCtables}{\StrLeft{parEgo}{\ntables}}
\providecommand{\algBtables}{\StrLeft{external-cma}{\ntables}}
\providecommand{\algAtables}{\StrLeft{cma}{\ntables}}
\providecommand{\ntables}{4}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{cma_exter_ego_parEg/}
\providecommand{\algorithmA}{cma}
\providecommand{\algorithmB}{ego}
\providecommand{\algorithmC}{external-cma}
\providecommand{\algorithmD}{parEgo}
